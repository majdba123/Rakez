...
class ProcessContractInfoCsv implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            try {
                ...
                $service->upsertContractInfoFromCsvImport($this->contractId, $merged, $contract);
                ...
                Storage::disk('local')->delete($csvImport->file_path);
                Log::info("ContractInfo CSV import #{$this->csvImportId}: store failed; nothing saved.");
            ...
            Log::info("ContractInfo CSV import #{$this->csvImportId} completed: {$successful} ok.");
    ...
    {
        $request = new StoreContractInfoRequest;
