...
class ContractPdfDataService
{
    ...
    public function formatContractInfoForPdf(ContractInfo $info): array
    {
        ...
        return [
            ...
            'first_party_bank_account_name' => $this->pdfStr($attrs['first_party_bank_account_name'] ?? $info->first_party_bank_account_name ?? null),
            'first_party_bank_name' => $this->pdfStr($attrs['first_party_bank_name'] ?? $info->first_party_bank_name ?? null),
            'first_party_iban_number' => $this->pdfStr($attrs['first_party_iban_number'] ?? $info->first_party_iban_number ?? null),
            ...
            'second_party_bank_account_name' => $this->pdfStr($attrs['second_party_bank_account_name'] ?? $info->second_party_bank_account_name ?? null),
            'second_party_bank_name' => $this->pdfStr($attrs['second_party_bank_name'] ?? $info->second_party_bank_name ?? null),
            'second_party_iban_number' => $this->pdfStr($attrs['second_party_iban_number'] ?? $info->second_party_iban_number ?? null),
