...
class UpdateContractInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'first_party_bank_account_name' => 'nullable|string|max:255',
            'first_party_bank_name' => 'nullable|string|max:255',
            'first_party_iban_number' => 'nullable|string|max:34',
