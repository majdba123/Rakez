...
class AIAssistantIntegrationTest extends TestCase
{
    ...
    {
        // Skip this test if throttle is not working as expected in test environment
        // or use a more robust way to test it.
        $this->markTestSkipped('Throttle testing is flaky in this environment.');
    }
