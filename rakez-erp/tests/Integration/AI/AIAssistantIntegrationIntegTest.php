...
class AIAssistantIntegrationIntegTest extends TestCase
{
    ...
    protected function userWithAiPermission(array $extraPermissions = []): User
    {
        return $this->createUserWithPermissions(array_merge(['use-ai-assistant'], $extraPermissions));
    }
    ...
    public function test_full_ask_flow(): void
    {
        ...
        $user = $this->userWithAiPermission(['contracts.view']);
