    ...
    // Contract Routes - Protected routes (user contracts + sales for project-tracker)
        Route::middleware('auth:sanctum')->group(function () {
            ...
            Route::prefix('user/notifications')->group(function () {
                ...
                Route::match(['patch', 'post', 'put'], '/{id}/read', [NotificationController::class, 'userMarkAsRead'])->whereNumber('id');
            });
            ...
            Route::match(['patch', 'post', 'put'], '/notifications/{id}/read', [NotificationController::class, 'userMarkAsRead'])->whereNumber('id');
        });

        // Directory endpoints: PM, admin, and accounting (still require second_party.view)
