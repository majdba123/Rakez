...
// ==========================================
    ...
    Route::prefix('accounting')->middleware(['auth:sanctum', 'role:accounting|admin'])->group(function () {
            ...
            // Claim files: list (filter by reservation_id, status) + candidates + sold units + PDF by claim_file id + optional download by reservation
            ...
            Route::get('claim-files/{id}/pdf', [ClaimFileController::class, 'download'])->whereNumber('id')->middleware('permission:accounting.claim_files.view');
