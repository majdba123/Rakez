...
@section('content')
    ...
    <table class="sand-kv" cellpadding="0" cellspacing="0">
        ...
        <tr><td>السجل التجاري</td><td class="sand-val-ltr">{{ $info_display['first_party_cr_number'] }}</td></tr>
        <tr><td>المفوّض بالتوقيع</td><td>{{ $info_display['first_party_signatory'] }}</td></tr>
        <tr><td>الجوال</td><td class="sand-val-ltr">{{ $info_display['first_party_phone'] }}</td></tr>
        <tr><td>البريد الإلكتروني</td><td class="sand-val-ltr">{{ $info_display['first_party_email'] }}</td></tr>
    </table>
    ...
    <table class="sand-kv" cellpadding="0" cellspacing="0">
        ...
        <tr><td>السجل التجاري</td><td class="sand-val-ltr">{{ $info_display['second_party_cr_number'] }}</td></tr>
        <tr><td>رقم الهوية</td><td class="sand-val-ltr">{{ $info_display['second_party_id_number'] }}</td></tr>
        ...
        <tr><td>الجوال</td><td class="sand-val-ltr">{{ $info_display['second_party_phone'] }}</td></tr>
        <tr><td>البريد الإلكتروني</td><td class="sand-val-ltr">{{ $info_display['second_party_email'] }}</td></tr>
    </table>
    ...
    <table class="sand-kv" cellpadding="0" cellspacing="0">
        ...
        <tr><td>رابط الموقع</td><td class="sand-val-ltr">{{ $info_display['location_url'] }}</td></tr>
    </table>

    <p class="sand-section">مدة الاتفاق والوكالة</p>
    <table class="sand-kv" cellpadding="0" cellspacing="0">
        <tr><td>مدة الاتفاق (أيام)</td><td class="sand-val-ltr">{{ $info_display['agreement_duration_days'] }}</td></tr>
        <tr><td>مدة الاتفاق (أشهر)</td><td class="sand-val-ltr">{{ $info_display['agreement_duration_months'] }}</td></tr>
        <tr><td>رقم الوكالة</td><td class="sand-val-ltr">{{ $info_display['agency_number'] }}</td></tr>
        <tr><td>تاريخ الوكالة</td><td>{{ $info_display['agency_date'] }}</td></tr>
        <tr><td>متوسط قيمة العقار</td><td class="sand-val-ltr">{{ $info_display['avg_property_value'] }}</td></tr>
