    ...
    <div class="login-container">
        <div class="login-card">
            <div class="logo">
                ...
                <h1>Rakez ERP</h1>
                <p>تسجيل دخول المستخدمين المصرّح لهم</p>
            </div>
            ...
            <form method="POST" action="/login" id="loginForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="name@example.com" autocomplete="email" required autofocus>
                    </div>
                </div>
        ...
        <div class="footer">
            <p>Rakez ERP • <a href="/">الصفحة الرئيسية</a></p>
        </div>
    </div>
