...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('marketing_budget_distributions', function (Blueprint $table) {
            ...
            $table->foreignId('employee_marketing_plan_id')->nullable()->constrained('employee_marketing_plans')->onDelete('cascade');
            $table->foreignId('developer_marketing_plan_id')->nullable()->constrained('developer_marketing_plans')->onDelete('cascade');
