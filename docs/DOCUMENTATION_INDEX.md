...
4. **AI Assistant v2 (Vue, separate repo):** [AI_V2_VUE_FRONTEND_PLAN.md](./AI_V2_VUE_FRONTEND_PLAN.md) and Postman collection [postman/collections/RAKEZ_ERP_AI_V2.postman_collection.json](./postman/collections/RAKEZ_ERP_AI_V2.postman_collection.json)
5. **Project Management API:** Postman collection [postman/collections/RAKEZ_ERP_Project_Management.postman_collection.json](./postman/collections/RAKEZ_ERP_Project_Management.postman_collection.json) (33 endpoints: Dashboard, Teams, Contracts, Second Party, Units, Boards, Photography, Developers). See [postman/README.md](./postman/README.md).
6. **Marketing (Full) API:** Postman collection [postman/collections/RAKEZ_ERP_Marketing_Full.postman_collection.json](./postman/collections/RAKEZ_ERP_Marketing_Full.postman_collection.json) (Dashboard, Projects, Developer/Employee Plans, Expected Sales, Tasks, Leads, Teams, Reports, Budget Distributions). See [postman/README.md](./postman/README.md).
7. **Sales (Full) API:** Postman collection [postman/collections/RAKEZ_ERP_Sales_Full.postman_collection.json](./postman/collections/RAKEZ_ERP_Sales_Full.postman_collection.json) (Dashboard, Projects, Reservations, Targets, Attendance, Team, Waiting list, Negotiations, Payment plan, Analytics, Commissions, Deposits, Admin project assignments). See [postman/README.md](./postman/README.md).
...
#### Sales (Full) API Collection

**File:** [postman/collections/RAKEZ_ERP_Sales_Full.postman_collection.json](./postman/collections/RAKEZ_ERP_Sales_Full.postman_collection.json)  
**Endpoints:** 90+ (Auth, Dashboard, Projects, Reservation context, Reservations, Targets, Attendance, Assignments, Team (Leader), Waiting list, Negotiations, Payment plan, Analytics, Commissions, Deposits, Admin project assignments).  
**Roles:** sales, sales_leader, admin. Uses `token` (set by 00 - Auth → Login). See [postman/README.md](./postman/README.md) for variables and usage.

#### Sales Module Collection (Legacy)

**File:** [POSTMAN_SALES_COLLECTION.json](./POSTMAN_SALES_COLLECTION.json)**Endpoints:** 40+**Categories:**
...
**File:** [postman/collections/AI_ASSISTANT_HELP_COLLECTION.json](./postman/collections/AI_ASSISTANT_HELP_COLLECTION.json)**Endpoints:** 6**Categories:**
...
**File:** [POSTMAN_AI_ASSISTANT_COLLECTION.json](./POSTMAN_AI_ASSISTANT_COLLECTION.json)**Endpoints:** 5 main + 8 examples**Categories:**
