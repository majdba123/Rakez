...
class AssistantKnowledgeTest extends TestCase
{
    ...
    public function test_admin_can_list_knowledge_entries(): void
    {
        ...
        // Verify entries were created and visible to the same connection
        ...
        $this->assertEquals(2, AssistantKnowledgeEntry::count(), 'Entries must be visible before request');
