...
use App\Http\Requests\Sales\UpdateAttendanceScheduleRequest;
...
class SalesAttendanceController extends Controller
{
    ...
    /**
     * Update an attendance schedule (leader only).
     */
    public function update(int $id, UpdateAttendanceScheduleRequest $request): JsonResponse
    {
        try {
            $schedule = $this->attendanceService->updateSchedule(
                $id,
                $request->validated(),
                $request->user()
            );
    ...
    /**
     * Delete an attendance schedule (leader only).
     */
    public function destroy(int $id): JsonResponse
    {
        try {
            $this->attendanceService->deleteSchedule($id, request()->user());
