...
<head>
    ...
    <title>سند حجز - {{ $reservation->id }}</title>
    <style>
...
<body>
        ...
        <table class="footer-tbl">
            <tr>
                <td style="text-align: right; width: 30%;">
                    <strong>شركة راكز العقارية</strong><br>
                    RAKEZ REAL ESTATE CO.
                </td>
                <td style="text-align: center; width: 40%;">
                    C.R. 1010691801<br>
                    المملكة العربية السعودية - الرياض 3130 شارع أنس بن مالك، حي الملقا
                </td>
    ...
    <table class="info-table">
        ...
        <tr>
            <td>اسم المطور / Developer</td>
            <td>{{ $project['developer_name'] ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td>رقم الوحدة / Unit No</td>
            <td>{{ $unit['number'] ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td>نوع الوحدة / Unit Type</td>
            <td>{{ $unit['type'] ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td>المساحة (م²) / Area</td>
            <td>{{ $unit['area'] ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td>الطابق / Floor</td>
    ...
    <table class="info-table">
        <tr>
            <td>اسم العميل / Client Name</td>
            <td>{{ $reservation->client_name }}</td>
        </tr>
        <tr>
            <td>رقم الجوال / Mobile</td>
